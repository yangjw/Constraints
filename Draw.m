...
//	UIBezierPath *path = [UIBezierPath bezierPathWithArcCenter:CGPointMake(40, 40) radius:(PROGREESS_WIDTH-PROGRESS_LINE_WIDTH)/2 startAngle:degreesToRadians(-210) endAngle:degreesToRadians(30) clockwise:YES];
	...
	[gradientLayer1 setColors:[NSArray arrayWithObjects:(id)[[UIColor orangeColor] CGColor],(id)[[UIColor whiteColor] CGColor], nil]];
...
//
	...
	[gradientLayer2 setColors:[NSArray arrayWithObjects:(id)[[UIColor blackColor] CGColor],(id)[[UIColor blueColor] CGColor], nil]];
